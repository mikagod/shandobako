		...
		<div class="content is-normal" :hidden="store.state.pdf">
			<nav class="navbar is-transparent mt-4">
				<div class="navbar-brand">
					...
					<router-link class="navbar-item" to="/main" style="width:180px;height: 71px">
						<img :src="nametext.url" alt="shandobako: a smart predicting device"  style="width:180px;height: 30px">
					</router-link>
          ...
          <span class="is-hidden1 navbar-item">
                           ...
                           to="/login">
							...
							<router-link style="margin-top: 1vw;" v-if="$route.path == '/login'" class="button is-info is-rounded" to="/register">
								<span>注册</span>
							</router-link>
          </span>
					<div class="flex-grow" />
					...
					<div class="navbar-end">
						<div class="navbar-item has-dropdown is-right is-hoverable">
							...
							<div class="navbar-dropdown is-right">
									<a class="navbar-item" @click="goto('/juecheye')">
										决策结果
									</a>
								<router-link class="navbar-item" to="/calendar">
									复圆日历
...
import {logout, getHomeConfiguration} from '../axios/api.js'
...
const nametext = ref({
  url: '/src/assets/img/shandobako_colorful.png'
})

const shandobako_colorful = getHomeConfiguration(2).then((res)=> {
  if (res.data.code == '0') {
