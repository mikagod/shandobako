        ...
        <div class="demo-collapse">
            <el-collapse v-model="activeNames" @change="handleChange">
                <el-collapse-item class='item' name="0">
                    ...
                    <div class="layout_title_top">时空坐标——大运决策系统</div>
                    <div class="layout_title">“10年周期命运变化” <br> 预测报告</div>

                    <div class="layout_creator">
                      <div  style="padding-left: 11vw">预测专家:
                ...
                <el-collapse-item class='item' name="1">
                    ...
                    <MyItem :sequence="(sequence + index)" v-for="(messageList,  index) in store.state.dayunresult.partOne.messageList1" :data="messageList">
                    </MyItem>
                ...
                <el-collapse-item class='item' title="第二部分" name="2">
                    ...
                    <div ><span class="key">{{ store.state.dayunresult.partTwo.tem1Bold }}</span></div>
